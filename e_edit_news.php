...
<body>
	...
	<div class="ts-main-content">
		...
		<div class="content-wrapper">
		   ...
		   $query="select title, news, status,date from eng where id=$news_id";
								...
								<form class="form-horizontal" method="post" action="e_worker_edit_news.php" enctype="multipart/form-data" onSubmit="return validate(this)" >
									<div class="form-group">
										...
										<div class="col-sm-10">
											...
											<input type="text" placeholder="enter news title here" name="title" id="title" value="<?=$res[0] ?>" class="form-control mb">
