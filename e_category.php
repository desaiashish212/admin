	...
	<div class="ts-main-content">
		<nav class="ts-sidebar">
			<ul class="ts-sidebar-menu">
				...
				<li class="open"><a href="#"><i class="fa fa-th-large"></i>Category</a>
					<ul>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">English Category</h2>
							<?php
				include_once ('connection.php');
				$sql = mysqli_query($con,"SELECT category.id, category.caregory_name,category.created_at,category.priority,category.status  FROM category where lang_status=3 ORDER BY priority ASC"); 
				
				$i = 0;
				?>
				          <a href="category.php?status=3">  <button class="btn btn-primary" type="submit">Add Category</button></a>
				...
				{ ?>
					...
					?>
						...
						<div class="panel panel-default">
							...
							<div class="panel-heading">English categories</div>
				...
				while($row=mysqli_fetch_array($sql))
				{
					...
					?>
						...
						<td>	<a href="priority_up.php?pr=<? echo $row['3']; ?> & lang=3" class="fa fa-chevron-circle-up" style="font-size:36px;color: #3e454c"></a>
							<a href="priority_down.php?pr=<? echo $row['3']; ?> & lang=3" class="fa fa-chevron-circle-down" style="font-size:36px;color: #2c3136"></a>
						</td>	
						...
						<td ><a href="categoryEnable.php?id=<? echo $row['0']; ?>&lang=3"><img src="img/enable.jpg" height="30" width="60"/></a>
						<a href="e_update_category.php?id=<?= $row["id"]?> "><img src="img/button_edit.JPG" height="30" width="60"/></a>
						...
						<td ><a href="e_delete_category.php?id=<?= $row["id"]?> "><img src="img/desable.jpg" height="30" width="60"/></a>
						<a href="e_update_category.php?id=<?= $row["id"]?> "><img src="img/button_edit.JPG" height="30" width="60"/></a></td>
