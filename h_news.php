			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title"><?echo $_GET["name"];?></h2>
							<a href="h_add_news.php?id=<?=$_GET["id"];?>&category=<?=$_GET["name"];?>">  <button class="btn btn-primary" type="submit">Add News</button></a>
				...
				while($row=mysqli_fetch_array($sql))
				{
					...
					?>
						...
						<td width="300">
							<? 
								...
								echo$string;
								?>
										</br><a href="h_read_more.php?id=<?=$row["id"]?>">Read More</a>
								<?
							?>	
						</td>				<!-- news containt-->
						<td width="100"><? echo $row['4']; ?></td>				<!-- Time containt-->
						<td width="100"><? echo $row['3']; ?></td>				<!-- Time containt-->
						<td width="50"><a href="h_edit_news.php?m_id=<?= $id ;?>&id=<?=$news_id;?>&category=<?=$_GET["name"];?>" class="btn btn-primary">Edit</a></td>
						<td width="50"><a href="h_delete_news.php?m_id=<?= $id ;?>&id=<?=$news_id;?>&category=<?=$_GET["name"];?>" class="btn btn-danger">Delete</td>
						<?
							if($row['5']==0){
						?>
						<td><a href="worker_news_notifications.php?m_id=<?= $id ;?>&id=<?= $news_id ;?>&lang=<?='2';?>&title=<?=$row['1'];?>&category=<?=$_GET["name"];?>&status=<?=$_GET['id'];?>" class="btn btn-info">Notify</a></td>
						<?
							}else{
						?>
					...
					?>
						...
						<td><? echo $row['3']; ?></td>
						<td width="50"><a href="h_edit_news.php?m_id=<?= $id ;?>&id=<?=$news_id;?>&category=<?=$_GET["name"];?>" class="btn btn-primary">Edit</td>
						<td width="50"><a href="h_delete_news.php?m_id=<?= $id ;?>&id=<?=$news_id;?>&category=<?=$_GET["name"];?>" class="btn btn-danger">Delete</a></td>
						<?
							if($row['5']==0){
						?>
						<td><a href="worker_news_notifications.php?m_id=<?= $id ;?>&id=<?= $news_id ;?>&lang=<?='2';?>&title=<?=$row['1'];?>&category=<?=$_GET["name"];?>&status=<?=$_GET['id'];?>" class="btn btn-info">Notify</a></td>
