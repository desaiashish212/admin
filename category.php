...
function validate(thisform)
{
	...
	var Name= thisform.name.value;
		...
		if(Name.length<3)
			{
				alert("Category name must be of atleast three characters");	
				thisform.name.focus();
				return false;
			}
						...
						<div class="row">
							<div class="col-md-6">
								<div class="panel panel-default">
									<div class="panel-heading">Category fields</div>
									<div class="panel-body">
									<? $status = $_GET['status']; ?>
										<form  name="news" method="post" action="worker_category.php"  onSubmit="return validate(this)" class="form-horizontal">
