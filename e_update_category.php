...
category.id = '$category'";
        ...
        ?>
						...
						<div class="panel panel-default">
							<div class="panel-heading">English Category Update</div>
							<div class="panel-body">
								<form class="form-horizontal" method="post" action="update_category_eng.php" onSubmit="return validate(this)" >
